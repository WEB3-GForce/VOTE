...
class MemberTest(unittest.TestCase):
    ...
    def test_init_hash(self):
        ...
        Note: This is fake data. Do not use it to make assumptions on how
        data will look in the actual system.
        """
        
        input_hash = {"full_name": "Timothy Peter Johnson",
                "first_name": "TIMOTHY",
                "last_name": "JOHNSON",
                "gender" : "MALE",
                "district": "SD-AL",
        ...
        member = Member(**input_hash)        
        for key, value in input_hash.iteritems():
