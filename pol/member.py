...
class Member(PrintableObject):
    ...
    def extract_voting_stances(self):
    ...
    def extract_vote_stance(self, vote):
        bill_id    = vote[0]
        for_or_agn = vote[1]
    ...
    def get_relations_stances(self):
        ...
        self.pro_rel_stances = filter(pro_stance, results)
        self.con_rel_stances = filter(con_stance, results)
